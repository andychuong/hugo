export namespace models {
	...
	export class HugoProjectInfo {
	    ...
	    static createFrom(source: any = {}) {
	        return new HugoProjectInfo(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.isHugoProject = source["isHugoProject"];
	        this.confidence = source["confidence"];
	        this.configFiles = source["configFiles"];
	        this.hasContentDir = source["hasContentDir"];
	        this.hasThemesDir = source["hasThemesDir"];
	        this.hasArchetypes = source["hasArchetypes"];
	        this.hasLayouts = source["hasLayouts"];
	...
	export class GitHubRepository {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.isHugoProject = source["isHugoProject"];
	        this.hugoInfo = this.convertValues(source["hugoInfo"], HugoProjectInfo);
	    }
...
export namespace services {
	...
	export class ThemeInstallStatus {
	    ThemeID: string;
	    ThemeName: string;
	    ProjectID: string;
	    Status: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ThemeInstallStatus(source);
	    }
